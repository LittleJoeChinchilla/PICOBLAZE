...
HD_PWD='D:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.runs/ila_debug_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_debug.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_debug.tcl
