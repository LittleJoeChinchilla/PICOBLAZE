...
set rc [catch {
  ...
  set_property ip_repo_paths d:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.cache/ip [current_project]
  set_property ip_output_repo d:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.cache/ip [current_project]
  set_property XPM_LIBRARIES XPM_MEMORY [current_project]
  add_files -quiet D:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.runs/synth_1/top.dcp
  add_files -quiet D:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.srcs/sources_1/ip/ila_debug/ila_debug.dcp
  set_property netlist_only true [get_files D:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.srcs/sources_1/ip/ila_debug/ila_debug.dcp]
  read_xdc -mode out_of_context -ref ila_debug -cells inst d:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.srcs/sources_1/ip/ila_debug/ila_debug_ooc.xdc
  set_property processing_order EARLY [get_files d:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.srcs/sources_1/ip/ila_debug/ila_debug_ooc.xdc]
  read_xdc -ref ila_debug -cells inst d:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.srcs/sources_1/ip/ila_debug/ila_v6_1/constraints/ila.xdc
  set_property processing_order EARLY [get_files d:/PROJEKT/PICOBLAZE/Picoblaze/Picoblaze.srcs/sources_1/ip/ila_debug/ila_v6_1/constraints/ila.xdc]
