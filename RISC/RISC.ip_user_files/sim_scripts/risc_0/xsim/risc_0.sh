...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xpm -L jtag_axi -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_9 -L blk_mem_gen_v8_3_2 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_6 -L xbip_pipe_v3_0_2 -L xbip_dsp48_macro_v3_0_12 -L unisims_ver -L unimacro_ver -L secureip --snapshot risc_0 xil_defaultlib.risc_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim risc_0 -key {Behavioral:sim_1:Functional:risc_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb risc_0.wdb xsim.dir)
